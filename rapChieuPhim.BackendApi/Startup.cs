...
using rapChieuPhim.Application.Catalog.Products;
...
namespace rapChieuPhim.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<rapChieuPhimDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));
            //
            services.AddIdentity<AppUser, AppRole>()
               .AddEntityFrameworkStores<rapChieuPhimDbContext>()
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger rapChieuPhim Solution", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger rapChieuPhim V1");
            });
